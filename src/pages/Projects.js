...
const data = [
  ...
  },
  {
    ...
    desc:
      "This is a wildfire tracker created using react js. It was created by using data" +
  ...
  },
  {
    ...
    desc:
      "This is a gallery application created using ReactJS and Firebase. Its basic function is to et users" +
  ...
  },
  {
    ...
    desc:
      "This is a flower classifier app created using Tensorflow classifier model created using " +
  ...
  },
  {
    ...
    desc:
      "This is a student management basic app, created using ReactJS which allows to keep tabs/data " +
  ...
  },
  {
    ...
    desc:
      "This is a chatbot created using microservice architecture. It has two services (react-front, python-back)" +
  ...
  },
  {
    ...
    desc:
      "This is a museum management system made in PHP and sql, which is hosted over a local site and does " +
  ...
  },
  {
    ...
    badges: ["HTML", "JavaScript", "CSS", "Bootstrap"],
    desc:
      "This is a sample website for museum which demonstrates all of its events and features in a very good" +
  ...
  },
  {
    ...
    desc:
      "This is a mobile application created using react native. It is a small online book store app for obile device" +
  ...
  },
  {
    ...
    desc:
      "This is a live chat app whre multiple users can talk to each other in real time." +
