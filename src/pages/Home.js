    ...
    <div style={{ zIndex: "2", color: "white" }}>
      ...
      <Container id="about-tag">
        ...
        <Row style={{ alignItems: "center" }}>
          ...
          >
            I am a Full Stack Developer located in India. I have a passion for
            creating full stack projects and solutions that can provide dynamic
            user experience and solve great challenges.
            <br />
            <br />
            Well organized guy, problem-solver, student and freelancer with high
            attention to detail.
            <br />
            <br />
            ...
            Interested in the entire full stack spectrum (both front and
        ...
        >
          <Col md={3} lg={3} xs={6}>
            ...
            <p className="round-box-text">Quick Learner and problem solver</p>
          </Col>
          <Col md={3} lg={3} xs={6}>
            <div className="round-box">
            ...
            <p className="round-box-text">
              Gets the job done and responsible attitude
            </p>
          </Col>
          <Col md={3} lg={3} xs={6}>
            <div className="round-box">
            ...
            <p className="round-box-text">
              Strong preference for easy to use, intuitive solutions
            </p>
          </Col>
          <Col md={3} lg={3} xs={6}>
            <div className="round-box">
            ...
            <p className="round-box-text">
              Nothing needs to be static, I love making ideas come to life
            </p>
          </Col>
        </Row>
      </Container>
      ...
      <Container fluid className="mt-5 p-0">
        ...
        <Row style={{ margin: "0" }}>
          <Col md={6} lg={6} xs={12} style={{ padding: "2rem 3rem" }}>
            ...
            <Row>
              <p>
                I am interested in freelance oppotunities - especially ambitious
                or large projects. However, if you have other requests or
                concerns, don't hesitate to use the form.
              </p>
            </Row>
            <Row>
          ...
          <Col md={6} lg={6} xs={12} style={{ padding: "0" }}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d471218.3856032584!2d88.0495282352594!3d22.676385755147976!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f882db4908f667%3A0x43e330e68f6c2cbc!2sKolkata%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1655479094106!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: "0" }}
              allowFullScreen=""
